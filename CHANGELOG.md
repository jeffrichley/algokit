...
- Migrate documentation to YAML generation system

## v0.15.0 (2025-10-08)

### Feat

- Add unified CI/CD workflow pipeline

### Fix

- Add 'hart' to codespell ignore list

### Refactor

- Use .codespellignore file for spell check exceptions

## v0.14.0 (2025-10-08)

### Feat

- Add comprehensive HIRO tests and algorithm family documentation
