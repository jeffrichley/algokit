...
from agloviz.scenes.planning.bfs.breadth_first_search_scene import (  # noqa: E402
    BreadthFirstSearchScene,
)
from algokit.core.helpers import HarborNetScenario  # noqa: E402


def test_bfs_scene() -> BreadthFirstSearchScene:
